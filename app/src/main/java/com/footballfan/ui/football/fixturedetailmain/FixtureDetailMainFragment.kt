...
class FixtureDetailMainFragment : RainbowCakeFragment<FixtureDetailMainViewState,FixtureDetailMainViewModel>(){
    companion object {
        ...
        fun newInstance(homeScore: String,awayScore :String,awayLogo: String,homeLogo: String): FixtureDetailMainFragment { //TODO shift to parentscope viewmodel and get data from there
    ...
    private fun initViewPager2WithFragments(view: View){
        ...
        val names:Array<String> = arrayOf("asd","asd","adsa")
